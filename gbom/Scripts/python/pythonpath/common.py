...
def getFirstPageInfo():
    ...
    if firstPageStyleName.startswith("Первый лист "):
        ...
        firstRowCount = 29 if firstPageVariant in "12" else 27
        otherRowCount = 32
...
def rebuildTable():
    ...
    columnSeparators[1].Position = 2304  # int((7+84)/395*10000)
    columnSeparators[2].Position = 3443  # int((7+84+45)/395*10000)
    columnSeparators[3].Position = 5215  # int((7+84+45+70)/395*10000)
    columnSeparators[4].Position = 6861  # int((7+84+45+70+65)/395*10000)
    columnSeparators[5].Position = 7114  # int((7+84+45+70+65+10)/395*10000)
    columnSeparators[6].Position = 7367  # int((7+84+45+70+65+10+10)/395*10000)
    columnSeparators[7].Position = 7620  # ...
    columnSeparators[8].Position = 7873
    columnSeparators[9].Position = 8127
    columnSeparators[10].Position = 8380
    columnSeparators[11].Position = 8633
    columnSeparators[12].Position = 8886
    columnSeparators[13].Position = 9139
    columnSeparators[14].Position = 9392
