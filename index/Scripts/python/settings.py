...
*.xml (вспомогательный)."""
    ...
    editControlModel01.Value = config.getint("doc", "empty rows between diff ref")
...
одинаковым наименованием."""
    ...
    checkModel02.State = int(config.getboolean("doc", "concatenate same name groups"))
...
если она состоит из одного компонента."""
    ...
    checkModel05.PositionY = checkModel04.PositionY + checkModel03.Height
...
вверху страницы будут удалены."""
    ...
    checkModel09.PositionY = checkModel08.PositionY + checkModel08.Height
    checkModel09.Width = tabsModel.Width - 10
    checkModel09.Height = checkModel00.Height
    checkModel09.Name = "CheckBox09"
    checkModel09.State = int(config.getboolean("doc", "footprint only"))
    checkModel09.Label = "\"Посад.место\" без наименования библиотеки"
...
будет указано без наименования библиотеки."""
    ...
    checkModel010.PositionY = checkModel09.PositionY + checkModel09.Height
    checkModel010.Width = tabsModel.Width - 10
    checkModel010.Height = checkModel00.Height
    checkModel010.Name = "CheckBox010"
    checkModel010.State = int(config.getboolean("doc", "split row by \\n"))
    checkModel010.Label = "Обрабатывать \"\\n\" как переход на новую строку"
...
то возле обозначения компонента
в перечне, будет указан символ
"*"."""
    ...
    editControlModel14.Width = (tabsModel.Width - labelModel14.Width - 10 - 3) / 2
    ...
    editControlModel14_1 = pageModel1.createInstance(
        "com.sun.star.awt.UnoControlEditModel"
    )
    editControlModel14_1.Width = editControlModel14.Width
    editControlModel14_1.Height = labelModel14.Height
    editControlModel14_1.PositionX = editControlModel14.PositionX + editControlModel14.Width + 10 - 1
    editControlModel14_1.PositionY = labelModel14.PositionY
    editControlModel14_1.Name = "EditControl14_1"
    editControlModel14_1.Text = config.get("fields", "adjustable regex")
    pageModel1.insertByName("EditControl14_1", editControlModel14_1)

    labelModel14_1 = pageModel1.createInstance(
        "com.sun.star.awt.UnoControlFixedTextModel"
    )
    labelModel14_1.PositionX = editControlModel14.PositionX + editControlModel14.Width
    labelModel14_1.PositionY = labelModel10.Height * 4
    labelModel14_1.Width = 10
    labelModel14_1.Height = labelModel10.Height
    labelModel14_1.VerticalAlign = uno.Enum(
        "com.sun.star.style.VerticalAlignment",
        "MIDDLE"
    )
    labelModel14_1.Align = uno.Enum(
        "com.sun.star.style.HorizontalAlignment",
        "CENTER"
    )
    labelModel14_1.Name = "Label14_1"
    labelModel14_1.Label = "="
    pageModel1.insertByName("Label14_1", labelModel14_1)
...
перечня элементов."""
    ...
    labelModel15_1.PositionY = labelModel10.Height * 5
...
class ButtonOKActionListener(unohelper.Base, XActionListener):
    ...
    def actionPerformed(self, event):
        ...
        config.set("doc", "empty rows between diff ref",
        ...
        config.set("fields", "adjustable regex",
            page1.getControl("EditControl14_1").Text
        )
