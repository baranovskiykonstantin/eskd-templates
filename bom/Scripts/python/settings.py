...
будет помещено в графу "Наименование"."""
    ...
    labelModel16.Label = "Код продукции:"
    labelModel16.HelpText = """\
Значение поля с указанным именем
будет помещено в графу "Код продукции"."""
...
будет помещено в графу "Поставщик"."""
    ...
    labelModel18 = pageModel1.createInstance(
        "com.sun.star.awt.UnoControlFixedTextModel"
    )
    labelModel18.PositionX = 0
    labelModel18.PositionY = labelModel10.Height * 5
    labelModel18.Width = labelModel10.Width
    labelModel18.Height = labelModel10.Height
    labelModel18.VerticalAlign = uno.Enum(
        "com.sun.star.style.VerticalAlignment",
        "MIDDLE"
    )
    labelModel18.Name = "Label18"
    labelModel18.Label = "Куда входит:"
    labelModel18.HelpText = """\
Значение поля с указанным именем
будет помещено в графу
"Куда входит (обозначение)"."""
    pageModel1.insertByName("Label18", labelModel18)

    editControlModel18 = pageModel1.createInstance(
        "com.sun.star.awt.UnoControlEditModel"
    )
    editControlModel18.Width = tabsModel.Width - labelModel18.Width - 3
    editControlModel18.Height = labelModel18.Height
    editControlModel18.PositionX = labelModel18.Width
    editControlModel18.PositionY = labelModel18.PositionY
    editControlModel18.Name = "EditControl18"
    editControlModel18.Text = config.get("fields", "for what")
    pageModel1.insertByName("EditControl18", editControlModel18)

    labelModel13 = pageModel1.createInstance(
        "com.sun.star.awt.UnoControlFixedTextModel"
    )
    labelModel13.PositionX = 0
    labelModel13.PositionY = labelModel10.Height * 6
...
будет помещено в графу "Примечание"."""
    ...
    labelModel15.PositionY = labelModel10.Height * 7
...
ведомости."""
    ...
    labelModel15_1.PositionY = labelModel10.Height * 7
...
останется без изменений."""
    ...
    checkModel23.State = int(config.getboolean("stamp", "doc type is file name"))
...
class ButtonOKActionListener(unohelper.Base, XActionListener):
    ...
    def actionPerformed(self, event):
        ...
        config.set("fields", "for what",
            page1.getControl("EditControl18").Text
        )
